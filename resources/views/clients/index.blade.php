                        ...
                        <thead>
                            <tr>
                                <th class="px-6 py-3 bg-gray-50 text-left">
                                    <span
                                        class="text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Company</span>
                                </th>
                                <th class="px-6 py-3 bg-gray-50 text-left">
                                    <span
                                ...
                                <th class="px-6 py-3 bg-gray-50 text-left">
                                    <span
                                        class="text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Address</span>
                                </th>
                                <th class="px-6 py-3 bg-gray-50 text-left">
                                    <span
                            ...
                            @foreach ($clients as $client)
                                <tr class="bg-white">
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-900">
                                        ...
                                        {{-- <a href="{{ route('clients.delete', $client) }}" class="underline">Delete</a> --}}
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
